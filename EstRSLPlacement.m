function voxelmap = EstRSLPlacement(RSU_config,angleRange,angularRes,...
    disRange,roi_POM,POM_grids,POM_sz,idx_linear,gridSize)
% RSU_config: configureMatrix Nx6 matrix where row corresponds to RSLs
...
% ray discretization (Fig.5 in the paper) 
for j = 1:num_rsu
